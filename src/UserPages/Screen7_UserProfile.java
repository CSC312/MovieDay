 ...
 * @author Nino
 */
public class Screen7_UserProfile extends javax.swing.JFrame {

    /**
     * Creates new form Screen7_UserProfile
     */
    public Screen7_UserProfile() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Screen7_UserProfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Screen7_UserProfile().setVisible(true);
            }
        });
    }
